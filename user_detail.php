<html>
    <head>
        <title>User Detail -TiketSaya</title>
        <meta charset="UTF-8">
        <meta name="description" content="User Detail TiketSaya Admin">
        <meta name="keywords" content="tiketsaya, Web User Detail, Login Tiket Saya">
                ...
                <div class="col-md-12">
                    ...
                    <nav aria-label="breadcrumb" >
                        <ol class="breadcrumb" style="background: none; margin-left: -13px;">
                          ...
                          <li class="breadcrumb-item active"  style="color: #21272C;" aria-current="page">Profile Detail</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="col-md-10">
                                <form>
                                    ...
                                    <div class="form-group form-user">
                                      ...
                                      <input type="text" class="form-control input-type-primary-saya" id="form-user" aria-describedby="emailHelp" placeholder="Julia Aulie">
                                    </div>
                                    <div class="form-group">
                                      <label class="title-input-primary-saya" for="exampleInputEmail1">Email Address</label>
                                      <input type="email" class="form-control input-type-primary-saya" id="exampleInputEmail1" placeholder="JuliaAulie@gmail.com">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-primary-saya">Save Now</button>
                        ...
                        <div class="row">
                            ...
                            <div class="content col-md-12">
                                ...
                                <div class="user-info">
                                    ...
                                    <p class="sub-title">
                                        You are able to delete the user and<br>once you deleted it — it is gone
                                    </p>
